		...
		if (this.props.loadedClient) {
			return (
				<Modal
					...
					footer={
						<Button type="primary" onClick={() => this.props.setClientInfoVisibility(false)}>
							OK
						</Button>
					}
				>
...
function matchDispatchToProps(dispatch) {
	return bindActionCreators({ setClientInfoVisibility: setClientInfoVisibility }, dispatch);
}
