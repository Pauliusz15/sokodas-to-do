			...
			>
				<Form layout="vertical">
					<FormItem
						...
						required={true}
					>
						<Input value={this.state.nameInput} onChange={this.changeNameVal} suffix={suffixName} />
					</FormItem>
					<FormItem
					...
					<FormItem label="Comment">
						<TextArea rows={4} value={this.state.commentInput} onChange={this.changeCommentVal} />
					</FormItem>
				</Form>
			</Modal>
		);
